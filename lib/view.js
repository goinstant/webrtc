...
var STREAMING_CLASS = 'gi-streaming';
...
View.prototype.initialize = function() {
  if (this._expandContainer) {
    ...
    classes(this._expandList).add(LIST_CLASS);
...
View.prototype.expandUser = function(id) {
  ...
  var expandingUserEl = this.list.querySelector('[' + DATA_ID + '="' + id + '"]');
  var restoringUserEl = this._expandList.querySelector('.' + USER_CLASS);
...
View.prototype.addStream = function(user, stream, streamObj) {
  ...
  var userEl = container.querySelector('[' + DATA_ID + '="' + id + '"]');
  classes(userEl).add(STREAMING_CLASS);
...
View.prototype.removeStream = function(id) {
  ...
  var userEl = container.querySelector('[' + DATA_ID + '="' + id + '"]');
  classes(userEl).remove(STREAMING_CLASS);
